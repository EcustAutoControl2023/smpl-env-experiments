...
from .torch.awcql_impl import AWCQLImpl, DiscreteAWCQLImpl, AWCQLModules

__all__ = ["AWCQLConfig", "AWCQL", "DiscreteAWCQLConfig", "DiscreteAWCQL"]


@dataclasses.dataclass()
class AWCQLConfig(LearnableConfig):
    ...
    def create(self, device: DeviceArg = False, enable_ddp: bool = False) -> "AWCQL":
        return AWCQL(self, device, enable_ddp)
...
class AWCQL(QLearningAlgoBase[AWCQLImpl, AWCQLConfig]):
...
@dataclasses.dataclass()
class DiscreteAWCQLConfig(LearnableConfig):
    ...
    def create(
        ...
        return DiscreteAWCQL(self, device, enable_ddp)

    @staticmethod
    def get_type() -> str:
        return "discrete_awcql"


class DiscreteAWCQL(QLearningAlgoBase[DiscreteAWCQLImpl, DiscreteAWCQLConfig]):
    def inner_create_impl(self, observation_shape: Shape, action_size: int) -> None:
...
register_learnable(AWCQLConfig)
register_learnable(DiscreteAWCQLConfig)
